package com.example.kostkav3.solver.twophase;
...
public class Tools {
     ...
     *
     * @see_cs.min2phase.Tools#saveTo(java.io.DataOutput)
     */
     ...
     *
     * @see_cs.min2phase.Tools#initFrom(java.io.DataInput)
     */
     ...
     *
     * The random source can be set by {@linkcs.min2phase.Tools#setRandomSource(java.util.Random)}
     *
     ...
     *
     * @seecs.min2phase.Tools#setRandomSource(java.util.Random)
     * @seecs.min2phase.Search#solution(java.lang.String facelets, int maxDepth, long timeOut, long timeMin, int verbose)
     */
     ...
     *
     * @paramfacelets is the cube definition string , see {@linkcs.min2phase.Search#solution(java.lang.String facelets, int maxDepth, long timeOut, long timeMin, int verbose)}
