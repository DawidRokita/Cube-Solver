...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSelectTwoPhase.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                selectedAlgorithm = 1;
        ...
        btnLBL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                checkBoxNormalizeLBL.setVisibility(View.VISIBLE);
            }
        });

        btnCFOP.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                selectedAlgorithm = 3;
                textView28.setVisibility(View.INVISIBLE);
    ...
    private void setupUIViews() {
        ...
        textParametryLBL = findViewById(R.id.textParametryLBL);
